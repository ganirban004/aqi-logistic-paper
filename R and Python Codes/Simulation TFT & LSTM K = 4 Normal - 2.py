...
def simulate_data(n_dpy=100, n_year=5):
    ...
    beta_season1 = -0.5
    beta_season2 = -1.5
    beta_seasonality2 = 0.7
    beta_seasonality3 = 0.8
    gamma00 = -0.3
    gamma01 = 0.1
    gamma02 = 0.2
    gamma10 = 0.3
    ...
    y_vec[0] = np.random.choice([0, 1, 2, 3])
    ...
    for t in range(1, n + 1):
        ...
        I0 = int(prev_y == 0)
        I1 = int(prev_y == 1)
        I2 = int(prev_y == 2)   # category 3 is baseline
        ...
        F0 = norm.cdf(theta0 - eta0)
        F1 = norm.cdf(theta1 - eta1)
        F2 = norm.cdf(theta2 - eta2)
        ...
        y_vec[t] = np.random.choice([0, 1, 2, 3], p=probs)
